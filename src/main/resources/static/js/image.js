...
let principalName = $("#principal-username").val();
...
<div class="story-list__item">
   ...
   <div class="sl__item__header">
      <div><img src="/upload/${image.user.profileImageUrl}" alt=""  onerror="this.src='/images/user.jpg'"/><svg viewbox="0 0 110 110"><circle cx="55" cy="55" r="53" /></svg></div>
   ...
   <div class="sl__item__contents">
	...
	image.comments.forEach((comment) => {
		result += ` <div class="sl__item__contents__comment" id="comment-${comment.id}"  value="" >
       <p>
	...
	result += `
      ...
      <div class="sl__item__input">
         ...
         <button type="button" onClick="addComment(${image.id}, '${principalName}')">게시</button>
      </div>
      <!--댓글달기박스end-->
   </div>
</div>
...
function addComment(imageId, username) {
	...
	$.ajax({
		...
		let content = `
     <div class="sl__item__contents__comment" id="comment-${comment.id}"  value="" >
       <p>
         <b>${username} :</b>
         ${_data.commemtText}
       </p>
